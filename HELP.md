...
* The original package name 'io.confluent.developer.spring-kafka-confluent' is invalid and this project uses 'io.confluent.developer.springkafkaconfluent' instead.
